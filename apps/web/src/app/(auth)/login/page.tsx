          ...
          <div className="relative rounded-2xl border border-[var(--border-ui)] bg-[var(--bg-input)] backdrop-blur-xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1 h-px bg-[var(--bg-surface-hover)]" />
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="w-full flex items-center justify-center gap-2.5 rounded-xl border border-[var(--border-strong)] bg-[var(--bg-input)] py-3 text-sm font-medium text-stone-300 transition-colors"
              >
